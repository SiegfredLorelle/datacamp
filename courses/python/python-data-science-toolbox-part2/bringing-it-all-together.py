...
pops = zip(df_pop_ceb.loc[:, "Total Population"], df_pop_ceb.loc[:, "Urban population (% of total)"])
...
df_pop_ceb['Total Urban Population'] = [int((total_pop * urban_pop) / 100) for total_pop, urban_pop in pops_list]
